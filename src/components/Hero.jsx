...
export default function Hero() {
    return (
        <section className="flex flex-col justify-center items-center min-h-screen rounded-[2.5rem]  mx-6 px-6 py-16
        ...
        >
            ...
            >
                <h2 className="text-2xl font-semibold text-white mb-2">Want to share your plans or join something exciting nearby?</h2>
                <h3 className="text-lg text-purple-200 mb-4">Meet people who get you with Destini.</h3>
