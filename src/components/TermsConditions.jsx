...
const TermsConditions = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Terms and Conditions - Destini App</title>
                <meta name="description" content="Read the Terms and Conditions for using Destini app, including user conduct, liability, and legal guidelines." />
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content="Terms and Conditions - Destini App" />
                <meta property="og:description" content="Understand the policies and rules when using Destini, the social and creative activities app." />
